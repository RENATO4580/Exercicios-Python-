...
# cpf_original. Aqui o usuário digitara o cpf completo
...
# Enquanto(while) o valor de i for menor que 9, neste caso, irá até 8
# vai pegando um número por vez no cpf_original(digitado pelo usuario com
# 11 digitos) e vai adicionando, um ao lado outro, na variável cpf_9.
...
# Para cálcular o primeiro digito verificandor, iremos usar cada número do 
# cpf_9 multiplicando pelo peso que vai de 10 a 2 
peso = 10

# A variável resultado é ultilizada para guarda a soma do resultado da 
# multiplicação 
resultado = 0

# Variável i usada para obter um número por vez dp cpf_9 
i = 0
while i < 9:
    ...
    # sair de zero(0) e chega em 8. Assim a cada vez que o laço roda(executa)
...
# A variável resto da guarda o resultado do cálculo entre o resultado, que 
...
# Caso o resultado do cálculo resulta em número maior que 2, então faz-se 
# a subtração de de 11 por resto, que é o ersultado do cálculo. Para manter 
